...
public class PanelJuego extends JPanel implements MouseListener{
    ...
    int x = 30*14, y = 665-largo;
    float alturaMax, distanciaMax, tMax, thMax, sen, cos, angulo;
    DecimalFormat formato2 = new DecimalFormat("#.##");
    
    public PanelJuego(){
        setBounds(0, 0, 1500, 700);// x, y, largo, alto (fondo hud)
        setVisible(true);
    ...
    public void paint(Graphics g){
        ...
        g.drawImage(fondo.getImage(), 0, 153, 1500, 540, this);
        g.drawImage(balon.getImage(), 0, y, 50, 50, this);  
        g.drawImage(cubeta.getImage(), x, 611, 50, 50, this);
    ...
    private void hud(){
        ...
        jlTexto1.setBounds(230, 72, 200, 30);
        add(jlTexto1);
        ...
        jsAltura.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                evento_jsAltura();
                posicionY((int) (64-jsAltura.getValue()));
            }
        });
